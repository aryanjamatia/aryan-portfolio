                ...
                <div className="flex flex-wrap justify-center gap-4">
                  ...
                  {selectedProject.github && (
                    <a
                      ...
                      className="bg-gradient-to-r from-purple-600 to-purple-800 hover:from-purple-700 hover:to-purple-900 text-white px-8 py-3 rounded-xl text-lg font-semibold text-center transition-all duration-300 shadow-lg hover:shadow-purple-500/40"
                    >
                      View Code
                    </a>
                  )}
